...
export default function QrCodeGenerator() {
  const [qrText, setQrText] = useState("http://sabeerbikba.vercel.app/");
  ...
  const tailwindcss = {
    ...
    qrDownloadBtn:
      "h-11 rounded-md mt-4 bg-indigo-500 px-3.5 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500",
    button: {
      width: "110px",
      height: "42px",
      borderRadius: "11px",
      position: "relative",
      left: "-2px",
      backgroundColor: `${qrText === "" ? "#4446a6" : "#6366f1"}`,
    },
    tooltip: {
      position: "relative",
      bottom: "3.2px",
