...
export default function ColorConverter() {
  ...
  return (
    <div className="select-none flex flex-col gap-4 p-4">
      <Output4CC
        title="RGB"
        colorCode={rgb}
        handleChange={(e) => handleRgbChange(e.currentTarget.value)}
        setIsCopyBtnDisabled={(isDisabled) =>
          UPDATE_BUTTON_STATE("rgb", isDisabled)
        }
      ...
      <Output4CC
        ...
        setIsCopyBtnDisabled={(isDisabled) =>
          UPDATE_BUTTON_STATE("rgba", isDisabled)
        }
      ...
      <Output4CC
        ...
        setIsCopyBtnDisabled={(isDisabled) =>
          UPDATE_BUTTON_STATE("hex", isDisabled)
        }
      ...
      <Output4CC
        ...
        setIsCopyBtnDisabled={(isDisabled) =>
          UPDATE_BUTTON_STATE("hsl", isDisabled)
        }
      ...
      <div>
        ...
        <HuePicker color={hex} width="100%" onChange={handleColorPickers} />
        <br />
        <AlphaPicker color={hex} width="100%" onChange={handleColorPickers} />
        <div className="flex max-xl:flex-col max-xl:gap-5 justify-around mt-[20px]">
          <PhotoshopPicker
            color={hex}
          ...
          <div style={{ height: "300px" }}>
            <SwatchesPicker color={hex} onChange={handleColorPickers} />
          </div>
          <CirclePicker color={hex} onChange={handleColorPickers} />
        </div>
      </div>
    </div>
  );
